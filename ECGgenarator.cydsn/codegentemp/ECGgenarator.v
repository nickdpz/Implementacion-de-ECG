// ======================================================================
// ECGgenarator.v generated from TopDesign.cysch
// 05/19/2019 at 14:53
...
module top ;
	...
	wire [1:0] tmpOE__LEDS_net;
	wire [1:0] tmpFB_1__LEDS_net;
	wire [1:0] tmpIO_1__LEDS_net;
	wire [0:0] tmpINTERRUPT_0__LEDS_net;
	electrical [0:0] tmpSIOVREF__LEDS_net;
	...
	cy_psoc3_pins_v1_10
		...
		LEDS
		 (.oe(tmpOE__LEDS_net),
		  .y({2'b0}),
		  .fb({tmpFB_1__LEDS_net[1:0]}),
		  .io({tmpIO_1__LEDS_net[1:0]}),
		  .siovref(tmpSIOVREF__LEDS_net),
		  .interrupt({tmpINTERRUPT_0__LEDS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LEDS_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{2'b11} : {2'b11};
